...
class AnticipoTipoController extends  MaestroController
{

    public $tipo = "administracion";
    public $modelo = "CarAnticipoTipo";
    public $entidad = CarAnticipoTipo::class;

    /**
     * @Route("/cartera/administracion/anticipo/anticipotipo/lista", name="cartera_administracion_anticipo_anticipotipo_lista")
     */
    public function lista(Request $request, PaginatorInterface $paginator )
    {
        ...
        return $this->render('cartera/administracion/anticipo/anticipotipo/lista.html.twig', [
    ...
    /**
     *  @Route("/cartera/administracion/anticipo/anticipotipo/nuevo/{id}", name="cartera_administracion_anticipo_anticipotipo_nuevo")
     */
    public function nuevo(Request $request, $id)
    {
        ...
        if ($form->isSubmitted()) {
            if ($form->get('btnGuardar')->isClicked()) {
                ...
                $em->flush();
                return $this->redirect($this->generateUrl('cartera_administracion_anticipo_anticipotipo_detalle', array('id' => $arRegistro->getcodigoAnticipoTipoPk())));
            }
        }
        return $this->render('cartera/administracion/anticipo/anticipotipo/nuevo.html.twig', [
            'form' => $form->createView(),
    ...
    /**
     *  @Route("/cartera/administracion/anticipo/anticipotipo/detalle/{id}", name="cartera_administracion_anticipo_anticipotipo_detalle")
    ...
    public function detalle(Request $request, $id)
    {
        $em = $this->getDoctrine()->getManager();
        $arRegistro = $em->getRepository($this->entidad)->find($id);
        return $this->render('cartera/administracion/anticipo/anticipotipo/detalle.html.twig', [
    ...
    public function excelLista($arRegistros, $nombre)
    {
        ...
        if ($arRegistros) {
            ...
            foreach ($arRegistros as $arRegistro) {
                ...
                $hoja->setCellValue('A' . $j, $arRegistro['codigoAnticipoTipoPk']);
