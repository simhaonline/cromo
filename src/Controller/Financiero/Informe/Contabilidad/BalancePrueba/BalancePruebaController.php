...
namespace App\Controller\Financiero\Informe\Contabilidad\BalancePrueba;
...
{
//    /**
//     * @Route("/financiero/informe/contabilidad/balance/prueba", name="financiero_informe_contabilidad_balance_prueba")
//     */
