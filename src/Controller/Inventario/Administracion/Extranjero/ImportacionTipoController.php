...
class ImportacionTipoController extends  MaestroController
{

    public $tipo = "administracion";
    public $modelo = "InvImportanciaTipo";
    public $entidad = InvImportacionTipo::class;

    /**
     * @Route("/inventario/administracion/extranjero/importaciontipo/lista", name="inventario_administracion_extranjero_importaciontipo_lista")
     */
    public function lista(Request $request, PaginatorInterface $paginator )
    {
        ...
        $form = $this->createFormBuilder()
            ...
            ->add('consecutivo', TextType::class, array('required' => false ))
        ...
        if ($form->isSubmitted()) {
            ...
            if ($form->get('btnExcel')->isClicked()) {
                ...
                $this->excelLista($arRegistros, "importaciontipo");
            }
        }
        $arRegistros = $paginator->paginate($em->getRepository($this->entidad)->lista($raw), $request->query->getInt('page', 1), 30);
        return $this->render('inventario/administracion/extranjero/importaciontipo/lista.html.twig', [
    ...
    /**
     *  @Route("/inventario/administracion/extranjero/importaciontipo/nuevo/{id}", name="inventario_administracion_extranjero_importaciontipo_nuevo")
     */
    public function nuevo(Request $request, $id)
    {
        ...
        $form = $this->createForm( ImportacionTipoType::class, $arRegistro);
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
            if ($form->get('btnGuardar')->isClicked()) {
                ...
                $em->flush();
                return $this->redirect($this->generateUrl('inventario_administracion_extranjero_importaciontipo_detalle', array('id' => $arRegistro->getcodigoImportacionTipoPk())));
            }
        }
        return $this->render('inventario/administracion/extranjero/importaciontipo/nuevo.html.twig', [
            'form' => $form->createView(),
    ...
    /**
     *  @Route("/inventario/administracion/extranjero/importaciontipo/detalle/{id}", name="inventario_administracion_extranjero_importaciontipo_detalle")
    ...
    public function detalle(Request $request, $id)
    {
        $em = $this->getDoctrine()->getManager();
        $arRegistro = $em->getRepository($this->entidad)->find($id);
        return $this->render('inventario/administracion/extranjero/importaciontipo/detalle.html.twig', [
    ...
    public function excelLista($arRegistros, $nombre)
    {
        ...
        if ($arRegistros) {
            ...
            foreach ($arRegistros as $arRegistro) {
                ...
                $hoja->setCellValue('A' . $j, $arRegistro['codigoImportacionTipoPk']);
