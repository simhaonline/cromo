...
class SucursalController extends  MaestroController
{
    ...
    public $entidad = InvSucursal::class;

    /**
     * @Route("/inventario/administracion/general/sucursal/lista", name="inventario_administracion_general_sucursal_lista")
     */
    public function lista(Request $request, PaginatorInterface $paginator )
    {
        ...
        return $this->render('inventario/administracion/general/sucursal/lista.html.twig', [
    ...
    /**
     *  @Route("/inventario/administracion/general/sucursal/nuevo/{id}", name="inventario_administracion_general_sucursal_nuevo")
     */
    public function nuevo(Request $request, $id)
    {
        ...
        $form = $this->createForm( SucursalType::class, $arRegistro);
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
            if ($form->get('btnGuardar')->isClicked()) {
                ...
                $em->flush();
                return $this->redirect($this->generateUrl('inventario_administracion_general_sucursal_detalle', array('id' => $arRegistro->getcodigoSucursalPk())));
            }
        }
        return $this->render('inventario/administracion/general/sucursal/nuevo.html.twig', [
            'form' => $form->createView(),
    ...
    /**
     *  @Route("/inventario/administracion/general/sucursal/detalle/{id}", name="inventario_administracion_general_sucursal_detalle")
    ...
    public function detalle(Request $request, $id)
    {
        $em = $this->getDoctrine()->getManager();
        $arRegistro = $em->getRepository($this->entidad)->find($id);
        return $this->render('inventario/administracion/general/sucursal/detalle.html.twig', [
    ...
    public function excelLista($arRegistros, $nombre)
    {
        ...
        if ($arRegistros) {
            ...
            foreach ($arRegistros as $arRegistro) {
                ...
                $hoja->setCellValue('A' . $j, $arRegistro['codigoSucursalPk']);
