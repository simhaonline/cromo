...
use App\Form\Type\Inventario\BodegaType;
...

{
    ...
    public $entidad = InvBodega::class;

    /**
     * @Route("/inventario/administracion/inventario/bodega/bodega/lista", name="inventario_administracion_inventario_bodega_bodega_lista")
     */
    ...
    /**
     *  @Route("/inventario/administracion/inventario/bodega/bodega/nuevo/{id}", name="inventario_administracion_inventario_bodega_bodega_nuevo")
     */
    public function nuevo(Request $request, $id)
    {
        ...
        $form = $this->createForm( BodegaType::class, $arRegistro);
        $form->handleRequest($request);
    ...
    /**
     *  @Route("/inventario/administracion/inventario/bodega/bodega/detalle/{id}", name="inventario_administracion_inventario_bodega_bodega_detalle")
    ...
    public function excelLista($arRegistros, $nombre)
    {
        ...
        if ($arRegistros) {
            ...
            foreach ($arRegistros as $arRegistro) {
                ...
                $hoja->setCellValue('A' . $j, $arRegistro['codigoBodegaPk']);
