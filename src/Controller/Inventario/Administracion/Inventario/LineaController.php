...
use App\Form\Type\Inventario\LineaType;
...
class LineaController extends MaestroController
{
    ...
    public $entidad = InvLinea::class;

    /**
     * @Route("/inventario/administracion/inventario/linea/lista", name="inventario_administracion_inventario_linea_lista")
     */
    public function lista(Request $request, PaginatorInterface $paginator )
    {
        ...
        return $this->render('inventario/administracion/inventario/linea/lista.html.twig', [
    ...
    /**
     *  @Route("/inventario/administracion/inventario/linea/nuevo/{id}", name="inventario_administracion_inventario_linea_nuevo")
     */
    public function nuevo(Request $request, $id)
    {
        ...
        $form = $this->createForm( LineaType::class, $arRegistro);
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
            if ($form->get('btnGuardar')->isClicked()) {
                ...
                $em->flush();
                return $this->redirect($this->generateUrl('inventario_administracion_inventario_grupo_detalle', array('id' => $arRegistro->getcodigoLineaPk())));
            }
        }
        return $this->render('inventario/administracion/inventario/linea/nuevo.html.twig', [
            'form' => $form->createView(),
    ...
    /**
     *  @Route("/inventario/administracion/inventario/linea/detalle/{id}", name="inventario_administracion_inventario_linea_detalle")
    ...
    public function detalle(Request $request, $id)
    {
        $em = $this->getDoctrine()->getManager();
        $arRegistro = $em->getRepository($this->entidad)->find($id);
        return $this->render('inventario/administracion/inventario/linea/detalle.html.twig', [
    ...
    public function excelLista($arRegistros, $nombre)
    {
        ...
        if ($arRegistros) {
            ...
            foreach ($arRegistros as $arRegistro) {
                ...
                $hoja->setCellValue('A' . $j, $arRegistro['codigoLineaPk']);
