...
class MovimientoController extends Controller
{
     ...
     * @Route("/inv/mov/inventario/movimiento/lista/documentos/{tipoDocumento}", name="inv_mov_inventario_movimiento_documentos_lista")
     */
     ...
     * @param $tipoDocumento
     * @return \Symfony\Component\HttpFoundation\Response
     * @Route("/inv/mov/inventario/movimiento/lista/movimientos/{tipoDocumento}/{codigoDocumento}", name="inv_mov_inventario_movimiento_lista")
     */
    ...
    public function detalle(Request $request, $id)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($form->get('btnAutorizar')->isClicked()) {
                $em->getRepository('App:Inventario\InvMovimiento')->actualizar($arMovimiento, $arrValor, $arrCantidad, $arrDescuento, $arrIva);
                $em->getRepository('App:Inventario\InvMovimiento')->autorizar($arMovimiento);
                return $this->redirect($this->generateUrl('inv_mov_inventario_movimiento_detalle', ['id' => $id]));
            }
...
//                $objFormatoSolicitud->Generar($em, $id);
            ...
            if ($form->get('btnAprobar')->isClicked()) {
                $em->getRepository('App:Inventario\InvMovimiento')->aprobar($arMovimiento);
                return $this->redirect($this->generateUrl('inv_mov_inventario_movimiento_detalle', ['id' => $id]));
            }
    ...
    /**
     * @Route("/inv/mov/inventario/movimiento/detalle/nuevo/{id}", name="inv_mov_inventario_movimiento_detalle_nuevo")
     */
    ...
    /**
     * @Route("/inv/mov/inventario/movimiento/detalle/ordencompra/nuevo/{id}", name="inv_mov_inventario_movimiento_ordencompra_detalle_nuevo")
     */
