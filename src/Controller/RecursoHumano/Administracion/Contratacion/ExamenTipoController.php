...
class ExamenTipoController extends  MaestroController
{
    public $tipo = "administracion";
    public $modelo = "RhuExamenTipo";
    public $entidad = RhuExamenTipo::class;

    /**
     * @Route("/recursohumano/administracion/contratacion/examentipo/lista", name="recursohumano_administracion_contratacion_examentipo_lista")
     */
    public function lista(Request $request, PaginatorInterface $paginator )
    {
        ...
        return $this->render('recursohumano/administracion/contratacion/examentipo/lista.html.twig', [
    ...
    /**
     *  @Route("/recursohumano/administracion/contratacion/examentipo/nuevo/{id}", name="recursohumano_administracion_contratacion_examentipo_nuevo")
     */
    ...
    /**
     *  @Route("/recursohumano/administracion/contratacion/examentipo/detalle/{id}", name="recursohumano_administracion_contratacion_examentipo_detalle")
    ...
    public function detalle(Request $request, $id)
    {
        $em = $this->getDoctrine()->getManager();
        $arRegistro = $em->getRepository($this->entidad)->find($id);
        return $this->render('recursohumano/administracion/contratacion/examentipo/detalle.html.twig', [
    ...
    public function excelLista($arRegistros, $nombre)
    {
        ...
        if ($arRegistros) {
            ...
            foreach ($arRegistros as $arRegistro) {
                ...
                $hoja->setCellValue('A' . $j, $arRegistro['codigoExamenTipoPk']);
                $hoja->setCellValue('B' . $j, $arRegistro['nombre']);
                $hoja->setCellValue('C' . $j, $arRegistro['ingreso']);
                $j++;
            }
