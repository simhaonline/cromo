...
class AporteController extends ControllerListenerGeneral
{
    ...
    */
    ...
    private function generarPlano($arAporte)
    {
        ...
        $arAporteDetalles = new \Brasa\RecursoHumanoBundle\Entity\RhuSsoAporte();
        $arAporteDetalles = $em->getRepository('BrasaRecursoHumanoBundle:RhuSsoAporte')->findBy(array('codigoPeriodoDetalleFk' => $codigoPeriodoDetalle));
        foreach ($arAporteDetalles as $arAporteDetalle) {
            //1	2	1	2	N	Tipo de registro	Obligatorio. Debe ser 02.
            fputs($ar, $this->RellenarNr($arAporteDetalle->getTipoRegistro(), "0", 2, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getSecuencia(), "0", 5, "I"));
            //3	2	8	9	A	Tipo documento el cotizante	Obligatorio. Lo suministra el aportante. Los valores validos son:
            fputs($ar, $this->RellenarNr($arAporteDetalle->getTipoDocumento(), " ", 2, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getEmpleadoRel()->getPermisoEspecial() != "" ? $arAporteDetalle->getEmpleadoRel()->getPermisoEspecial() : $arAporteDetalle->getEmpleadoRel()->getNumeroIdentificacion(), " ", 16, "D"));
            //5	2	26	27	N	Tipo de cotizante	Obligatorio. Lo suministra el aportante. Los valores validos son:
            fputs($ar, $this->RellenarNr($arAporteDetalle->getTipoCotizante(), "0", 2, "I"));
            //6	2	28	29	N	Subtipo de cotizante	Obligatorio. Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getSubtipoCotizante(), "0", 2, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getExtranjeroNoObligadoCotizarPension(), " ", 1, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getColombianoResidenteExterior(), " ", 1, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getSuspensionTemporalContratoLicenciaServicios(), " ", 1, "D"));
            //25	1	147	147	A	IGE: Incapacidad Temporal por Enfermedad General	Puede ser un blanco o X. Lo suministra el aportante.
            fputs($ar, $this->RellenarNr($arAporteDetalle->getIncapacidadGeneral(), " ", 1, "D"));
            //26	1	148	148	A	LMA: Licencia de Maternidad  o de Paternidad	Puede ser un blanco o X. Lo suministra el aportante.
            fputs($ar, $this->RellenarNr($arAporteDetalle->getLicenciaMaternidad(), " ", 1, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getVacaciones(), " ", 1, "D"));
            //28	1	150	150	A	AVP: Aporte Voluntario	Puede ser un blanco o X. Lo suministra el aportante.
            fputs($ar, $this->RellenarNr($arAporteDetalle->getAporteVoluntario(), " ", 1, "D"));
            //29	1	151	151	A	VCT: Variación centros de trabajo	Puede ser un blanco o X. Lo suministra el aportante.
            fputs($ar, $this->RellenarNr($arAporteDetalle->getVariacionCentrosTrabajo(), " ", 1, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getIncapacidadAccidenteTrabajoEnfermedadProfesional(), "0", 2, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCodigoEntidadPensionPertenece(), " ", 6, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCodigoEntidadPensionTraslada(), " ", 6, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCodigoEntidadSaludPertenece(), " ", 6, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCodigoEntidadSaludTraslada(), " ", 6, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCodigoEntidadCajaPertenece(), " ", 6, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getDiasCotizadosPension(), "0", 2, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getDiasCotizadosSalud(), "0", 2, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getDiasCotizadosRiesgosProfesionales(), "0", 2, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getDiasCotizadosCajaCompensacion(), "0", 2, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getSalarioBasico(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getSalarioIntegral(), " ", 1, "D"));
            //42	9	202	210	N	IBC Pensión	Obligatorio. Lo suministra el aportante.
            fputs($ar, $this->RellenarNr($arAporteDetalle->getIbcPension(), "0", 9, "I"));
            //43	9	211	219	N	IBC Salud	Obligatorio. Lo suministra el aportante.
            fputs($ar, $this->RellenarNr($arAporteDetalle->getIbcSalud(), "0", 9, "I"));
            //44	9	220	228	N	IBC Riesgos Laborales	Obligatorio. Lo suministra el aportante.
            fputs($ar, $this->RellenarNr($arAporteDetalle->getIbcRiesgosProfesionales(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getIbcCaja(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr(number_format($arAporteDetalle->getTarifaPension() / 100, 5, '.', ''), "0", 7, "I"));
            //47	9	245	253	N	Cotización obligatoria a Pensiones	Obligatorio. Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCotizacionPension(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getAporteVoluntarioFondoPensionesObligatorias(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCotizacionVoluntarioFondoPensionesObligatorias(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getTotalCotizacionFondos(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getAportesFondoSolidaridadPensionalSolidaridad(), "0", 9, "I"));
            //52	9	290	298	N	Aportes a Fondo de Solidad Pensional- Subcuenta de subsistencia	Lo suministra el aportante cuando aplique
            fputs($ar, $this->RellenarNr($arAporteDetalle->getAportesFondoSolidaridadPensionalSubsistencia(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr(number_format($arAporteDetalle->getTarifaSalud() / 100, 5, '.', ''), "0", 7, "I"));
            //55	9	315	323	N	Cotización Obligatoria a salud	Obligatorio. Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCotizacionSalud(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getValorUpcAdicional(), "0", 9, "I"));
            //57	15	333	347	A	N° autorización de la incapacidad por enfermedad general	Debe reportarse en blanco
            fputs($ar, $this->RellenarNr($arAporteDetalle->getNumeroAutorizacionIncapacidadEnfermedadGeneral(), " ", 15, "D"));
            //58	9	348	356	N	Valor de incapacidad por enfermedad general	Debe reportarse en blanco
            fputs($ar, $this->RellenarNr($arAporteDetalle->getValorIncapacidadEnfermedadGeneral(), "0", 9, "I"));
            //59	15	357	371	A	N° autorización de la licencia de maternidad o paternidad	Debe reportarse en blanco
            fputs($ar, $this->RellenarNr($arAporteDetalle->getNumeroAutorizacionLicenciaMaternidadPaternidad(), " ", 15, "D"));
            //60	9	372	380	N	Valor de la licencia de maternidad	Debe reportarse en cero
            fputs($ar, $this->RellenarNr($arAporteDetalle->getValorIncapacidadLicenciaMaternidadPaternidad(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr(number_format($arAporteDetalle->getTarifaRiesgos() / 100, 7, '.', ''), "0", 9, "I"));
            //62	9	390	398	N	Centro de Trabajo CT	Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCentroTrabajoCodigoCt(), "0", 9, "I"));
            //63	9	399	407	N	Cotización obligatoria al Sistema General de Riesgos Laborales	Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCotizacionRiesgos(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr(number_format($arAporteDetalle->getTarifaCaja() / 100, 5, '.', ''), "0", 7, "I"));
            //65	9	415	423	N	Valor aporte CCF	Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCotizacionCaja(), "0", 9, "I"));
            //66	7	424	430	N	Tarifa de aportes SENA	Lo suministra el aportante
            fputs($ar, $this->RellenarNr(number_format($arAporteDetalle->getTarifaSENA() / 100, 5, '.', ''), "0", 7, "I"));
            //67	9	431	439	N	Valor aportes SENA	Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCotizacionSena(), "0", 9, "I"));
            //68	7	440	446	N	Tarifa aportes ICBF	Lo suministra el aportante
            fputs($ar, $this->RellenarNr(number_format($arAporteDetalle->getTarifaIcbf() / 100, 5, '.', ''), "0", 7, "I"));
            //69	9	447	455	N	Valor aporte ICBF	Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCotizacionIcbf(), "0", 9, "I"));
            //70	7	456	462	N	Tarifa aportes ESAP	Lo suministra el aportante
            fputs($ar, $this->RellenarNr(number_format($arAporteDetalle->getTarifaAportesESAP() / 100, 5, '.', ''), "0", 7, "I"));
            //71	9	463	471	N	Valor aporte ESAP	Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getValorAportesESAP(), "0", 9, "I"));
            //72	7	472	478	N	Tarifa aportes MEN	Lo suministra el aportante
            fputs($ar, $this->RellenarNr(number_format($arAporteDetalle->getTarifaAportesMEN() / 100, 5, '.', ''), "0", 7, "I"));
            //73	9	479	487	N	Valor aporte MEN	Lo suministra el aportante
            fputs($ar, $this->RellenarNr($arAporteDetalle->getValorAportesMEN(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getTipoDocumentoResponsableUPC(), " ", 2, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getNumeroIdentificacionResponsableUPCAdicional(), " ", 16, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCotizanteExoneradoPagoAporteParafiscalesSalud(), " ", 1, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getCodigoAdministradoraRiesgosLaborales(), " ", 6, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getClaseRiesgoAfiliado(), " ", 1, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getIndicadorTarifaEspecialPensiones(), " ", 1, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaIngreso(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaRetiro(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaInicioVsp(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaInicioSln(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaFinSln(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaInicioIge(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaFinIge(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaInicioLma(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaFinLma(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaInicioVacLr(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaFinVacLr(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaInicioVct(), " ", 10, "D"));
            //92	10	635	644	A	Fecha fin  VCT Formato (AAAA-MM- DD). 	Cuando no se reporte la novedad el campo se dejará en blanco.
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaFinVct(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaInicioIrl(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getFechaFinIrl(), " ", 10, "D"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getIbcOtrosParafiscalesDiferentesCcf(), "0", 9, "I"));
            ...
            fputs($ar, $this->RellenarNr($arAporteDetalle->getNumeroHorasLaboradas(), "0", 3, "I"));
            //97	10	???	???	A	Fecha
            fputs($ar, $this->RellenarNr("", " ", 10, "D"));
            fputs($ar, "\n");
