...
{
    /**
     * @Route("rhu/mov/seleccion/aspirante/nuevo/{id}", name="rhu_mov_seleccion_aspirante_nuevo")
     */
    public function nuevo(Request $request, $id)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($form->get('guardarnuevo')->isClicked()) {
                ...
                return $this->redirect($this->generateUrl('rhu_mov_seleccion_aspirante_nuevo', ['codigoAspirante' => 0]));
            }
        }
