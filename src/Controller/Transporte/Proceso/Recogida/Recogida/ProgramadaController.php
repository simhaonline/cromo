...
{
   /**
    * @Route("/tte/pro/recogida/recogida/programada", name="tte_pro_recogida_recogida_programada")
    */    
    ...
    /**
     * @Route("/tte/pro/recogida/recogida/nuevo/{codigoRecogidaProgramada}", name="tte_pro_recogida_recogida_nuevo")
     */
