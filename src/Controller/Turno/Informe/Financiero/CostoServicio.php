...
class CostoServicio extends Controller
{
    /**
     * @Route("/turno/informe/financiero/costo/servicio/lista", name="turno_informe_financiero_costo_servicio_lista")
     */
    public function lista(Request $request)
    {
        ...
        $arCostosServicio = $paginator->paginate($em->getRepository(TurCostoServicio::class)->informe(), $request->query->getInt('page', 1), 1000);
        return $this->render('turno/informe/financiero/costoServicio.html.twig', [
            'arCostosServicio' => $arCostosServicio,
