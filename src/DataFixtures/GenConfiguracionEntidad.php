...
class GenConfiguracionEntidad extends Fixture
{
    ...
    public function load(ObjectManager $em)
    {
        ...
        $arrModuloInventario = $arrModuloInventario = [
            ...
            'precio,administracion,general,1,1',
...
//        /////////////////              INICIO ESTRACTURA MODULO DE CARTERA                             ////////////////
        $arrModuloCartera = [
            'cliente,administracion,general,0,0',
            'reciboTipo,administracion,general,0,0'];
...
//        /////////////////                 FIN ESTRACTURA MODULO DE CARTERA                             ////////////////
        ...
        $arrModuloRecursoHumano = ['aspirante,movimiento,seleccion,1,1',
            ...
            'tiempo,admin,nomina,0,0',
            'salud,admin,nomina,0,0',
            'pension,admin,nomina,0,0'];
...
//        /////////////////              INICIO ESTRACTURA MODULO DE GENERAL SISTEMA                     ////////////////
        ...
        $arrModuloTransporte = $arrModuloTransporte = [
            ...
            'cliente,administracion,transporte,1,1',
            ...
            'precio,administracion,comercial,1,1',
            'conductor,administracion,transporte,1,0',
            'condicion,administracion,comercial,0,0',
            'color,administracion,transporte,0,0',
            'vehiculo,administracion,transporte,1,0',
            ...
            'despachoTipo,administracion,general,0,0',
            'despachoRecogidaTipo,administracion,recogida,0,0'];
