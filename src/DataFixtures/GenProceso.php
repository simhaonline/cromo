...
class GenProceso extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $arrProcesos1 = array(
            ...
            ['codigo' => 'tteu0004',           'modulo' => 'Transporte',           'tipo' => 'u',           'grupo' => 'Transporte',         'nombre' => 'Correccion guia'],
            ['codigo' => 'tteu0005',           'modulo' => 'Transporte',           'tipo' => 'u',           'grupo' => 'Transporte',         'nombre' => 'Correccion guia valores'],
            ...
            ['codigo' => 'tteu0012',           'modulo' => 'Transporte',           'tipo' => 'u',           'grupo' => 'Transporte',         'nombre' => 'Correccion'],
            ...
            ['codigo' => 'ttei0014',           'modulo' => 'Transporte',           'tipo' => 'i',           'grupo' => 'Transporte',         'nombre' => 'Pendiente recaudo devolucion'],
            ...
            ['codigo' => 'rhuu0003',           'modulo' => 'RecursoHumano',        'tipo' => 'u',           'grupo' => 'Embargo',            'nombre' => 'BancoAgrario'],
            ...
            ['codigo' => 'rhui0007',           'modulo' => 'RecursoHumano',        'tipo' => 'i',           'grupo' => 'Aportes',            'nombre' => 'Seguridad social'],
            ...
            ['codigo' => 'invp0005',           'modulo' => 'Inventario',           'tipo' => 'p',           'grupo' => 'Venta',              'nombre' => 'Facturacion elecctronica'],
            ['codigo' => 'invu0001',           'modulo' => 'Inventario',           'tipo' => 'u',           'grupo' => 'Inventario',         'nombre' => 'Corregir fecha vencimiento'],
            ['codigo' => 'invu0002',           'modulo' => 'Inventario',           'tipo' => 'u',           'grupo' => 'Inventario',         'nombre' => 'Corregir factura'],
            ['codigo' => 'invu0003',           'modulo' => 'Inventario',           'tipo' => 'u',           'grupo' => 'Inventario',         'nombre' => 'Reliquidar'],
            ['codigo' => 'invi0001',           'modulo' => 'Inventario',           'tipo' => 'i',           'grupo' => 'Inventario',         'nombre' => 'Existencia'],
            ['codigo' => 'invi0002',           'modulo' => 'Inventario',           'tipo' => 'i',           'grupo' => 'Inventario',         'nombre' => 'Rotacion'],
            ['codigo' => 'invi0003',           'modulo' => 'Inventario',           'tipo' => 'i',           'grupo' => 'Inventario',         'nombre' => 'Stock bajo'],
            ['codigo' => 'invi0004',           'modulo' => 'Inventario',           'tipo' => 'i',           'grupo' => 'Inventario',         'nombre' => 'Existencia'],
            ['codigo' => 'invi0005',           'modulo' => 'Inventario',           'tipo' => 'i',           'grupo' => 'Inventario',         'nombre' => 'Kardex'],
            ['codigo' => 'invi0006',           'modulo' => 'Inventario',           'tipo' => 'i',           'grupo' => 'Inventario',         'nombre' => 'Disponible'],
            ['codigo' => 'invi0007',           'modulo' => 'Inventario',           'tipo' => 'i',           'grupo' => 'Inventario',         'nombre' => 'Detalles'],
            ['codigo' => 'invi0008',           'modulo' => 'Inventario',           'tipo' => 'i',           'grupo' => 'Inventario',         'nombre' => 'Inventario valorizado'],
            ['codigo' => 'invi0009',           'modulo' => 'Inventario',           'tipo' => 'i',           'grupo' => 'Inventario',         'nombre' => 'Kardex'],
            ...
            ['codigo' => 'finu0001',          'modulo' => 'Financiero',            'tipo' => 'u',           'grupo' => 'Contabilidad',       'nombre' => 'Registro'],
            ['codigo' => 'finu0002',          'modulo' => 'Financiero',            'tipo' => 'u',           'grupo' => 'Contabilidad',       'nombre' => 'Tercero'],
            ['codigo' => 'finu0003',          'modulo' => 'Financiero',            'tipo' => 'u',           'grupo' => 'Contabilidad',       'nombre' => 'Incosistencia documento'],
            ['codigo' => 'finu0004',          'modulo' => 'Financiero',            'tipo' => 'u',           'grupo' => 'Contabilidad',       'nombre' => 'Verificar consecutivo'],
