...
class CarCuentaCobrar
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="CarAplicacion", mappedBy="cuentaCobrarRel")
     */
    protected $aplicacionesCuentaCobrarRel;

    /**
     * @ORM\OneToMany(targetEntity="CarAplicacion", mappedBy="cuentaCobrarAplicacionRel")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Cartera\CarIngresoDetalle", mappedBy="cuentaCobrarRel")
     */
    protected $ingresosDetallesCuentaCobrarRel;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Cartera\CarMovimientoDetalle", mappedBy="cuentaCobrarRel")
     */
    protected $movimientosDetallesCuentaCobrarRel;
     ...
     * @return mixed
     */
    public function getAplicacionesCuentaCobrarRel()
    {
        return $this->aplicacionesCuentaCobrarRel;
    }
     ...
     * @return mixed
     */
    public function getAplicacionesCuentaCobrarAplicacionRel()
    {
        return $this->aplicacionesCuentaCobrarAplicacionRel;
    }
     ...
     * @return mixed
     */
    public function getIngresosDetallesCuentaCobrarRel()
    {
        return $this->ingresosDetallesCuentaCobrarRel;
    }

    /**
     * @param mixed $ingresosDetallesCuentaCobrarRel
     */
    public function setIngresosDetallesCuentaCobrarRel($ingresosDetallesCuentaCobrarRel): void
    {
        $this->ingresosDetallesCuentaCobrarRel = $ingresosDetallesCuentaCobrarRel;
    }

    /**
     * @return mixed
     */
    public function getMovimientosDetallesCuentaCobrarRel()
    {
        return $this->movimientosDetallesCuentaCobrarRel;
    }

    /**
     * @param mixed $movimientosDetallesCuentaCobrarRel
     */
