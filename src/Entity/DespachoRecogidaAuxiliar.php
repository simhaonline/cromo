...
/**
 * @ORM\Entity(repositoryClass="App\Repository\DespachoRecogidaAuxiliarRepository")
 */
class DespachoRecogidaAuxiliar
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\DespachoRecogida", inversedBy="despachosRecogidasAuxiliaresDespachoRecogidaRel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Auxiliar", inversedBy="despachosRecogidasAuxiliaresAuxiliarRel")
