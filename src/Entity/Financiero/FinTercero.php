...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Financiero\FinTerceroRepository")
...
class FinTercero
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\General\GenIdentificacion", inversedBy="finTercerosIdentificacionRel")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Financiero\FinRegistro", mappedBy="terceroRel")
     */
     ...
     */
    protected $carRecibosTerceroRel;
    ...
    /**
     * @param mixed $registrosTerceroRel
     */
