...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Inventario\InvRemisionRepository")
 * @ORM\EntityListeners({"App\Controller\Estructura\EntityListener"})
 */
class InvRemision
{
    public $infoLog = [
        "primaryKey" => "codigoRemisionPk",
        "todos"     => true,
    ];
    /**
     * @ORM\Id
     ...
     */
    private $codigoRemisionPk;

    /**
     * @ORM\Column(name="codigo_remision_tipo_fk", type="string", length=10, nullable=true)
     */
    private $codigoRemisionTipoFk;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Inventario\InvRemisionTipo", inversedBy="remisionesRemisionTipoRel")
     * @ORM\JoinColumn(name="codigo_remision_tipo_fk", referencedColumnName="codigo_remision_tipo_pk")
     * @Assert\NotBlank(
     *     message="Debe de seleccionar una opción"
     * )
     */
    protected $remisionTipoRel;

    /**
     * @ORM\ManyToOne(targetEntity="InvTercero", inversedBy="remisionesTerceroRel")
     ...
     * @return mixed
     */
    public function getCodigoRemisionPk()
    {
        return $this->codigoRemisionPk;
    }

    /**
     * @param mixed $codigoRemisionPk
     */
    public function setCodigoRemisionPk($codigoRemisionPk): void
    {
        $this->codigoRemisionPk = $codigoRemisionPk;
    }

    /**
     * @return mixed
     */
    public function getCodigoRemisionTipoFk()
    {
        return $this->codigoRemisionTipoFk;
    }

    /**
     * @param mixed $codigoRemisionTipoFk
     */
    public function setCodigoRemisionTipoFk($codigoRemisionTipoFk): void
    {
        $this->codigoRemisionTipoFk = $codigoRemisionTipoFk;
    }
     ...
     * @return mixed
     */
    public function getRemisionTipoRel()
    {
        return $this->remisionTipoRel;
    }

    /**
     * @param mixed $remisionTipoRel
     */
    public function setRemisionTipoRel($remisionTipoRel): void
    {
        $this->remisionTipoRel = $remisionTipoRel;
    }
     ...
     * @return mixed
     */
    public function getRemisionesDetallesPedidoRel()
    {
        return $this->remisionesDetallesPedidoRel;
    }

    /**
     * @param mixed $remisionesDetallesPedidoRel
     */
