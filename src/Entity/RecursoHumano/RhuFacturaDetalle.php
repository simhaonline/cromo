...
/**
 * @ORM\Entity(repositoryClass="App\Repository\RecursoHumano\RhuFacturaDetalleRepository")
...
class RhuFacturaDetalle
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuFactura", inversedBy="facturasDetallesFacturaRel")
     * @ORM\JoinColumn(name="codigo_factura_fk", referencedColumnName="codigo_factura_pk")
     */
    protected $facturaRel;

    /**
     * @ORM\ManyToOne(targetEntity="RhuItem", inversedBy="facturasDetallesItemRel")
     * @ORM\JoinColumn(name="codigo_item_fk", referencedColumnName="codigo_item_pk")
     */
    protected $itemRel;

//    /**
//     * @ORM\ManyToOne(targetEntity="RhuPedidoDetalle", inversedBy="facturasDetallesPedidoDetalleRel")
//     * @ORM\JoinColumn(name="codigo_pedido_detalle_fk", referencedColumnName="codigo_pedido_detalle_pk")
//     */
//    protected $pedidoDetalleRel;

    /**
     * @ORM\ManyToOne(targetEntity="RhuConcepto", inversedBy="facturasDetallesConceptoRel")
