...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Transporte\TteDestinatarioRepository")
 * @ORM\EntityListeners({"App\Controller\Estructura\EntityListener"})
 */
class TteDestinatario
{
    public $infoLog = [
        "primaryKey" => "codigoDestinatarioPk",
        "todos"     => true,
    ];
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\General\GenIdentificacion", inversedBy="tteDestinatariosIdentificacionRel")
