...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Turno\TurCotizacionDetalleRepository")
...
class TurCotizacionDetalle
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TurConcepto", inversedBy="cotizacionesDetallesConceptoRel")
     * @ORM\JoinColumn(name="codigo_concepto_fk", referencedColumnName="codigo_concepto_pk")
     */
    protected $conceptoRel;

    /**
     * @ORM\ManyToOne(targetEntity="TurModalidad", inversedBy="cotizacionesDetallesModalidadRel")
     * @ORM\JoinColumn(name="codigo_modalidad_fk", referencedColumnName="codigo_modalidad_pk")
     */
    protected $modalidadRel;

    /**
     * @ORM\ManyToOne(targetEntity="TurPuesto", inversedBy="cotizacionesDetallesPuestoRel")
