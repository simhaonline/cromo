...
/**
 * @ORM\Entity(repositoryClass="App\Repository\Turno\TurProgramacionRespaldoRepository")
 * @ORM\EntityListeners({"App\Controller\Estructura\EntityListener"})
 */
class TurProgramacionRespaldo
{
    public $infoLog = [
        "primaryKey" => "codigoProgramacionRespaldoPk",
        "todos"     => true,
    ];

    /**
     * @ORM\Id
     * @ORM\Column(name="codigo_programacion_respaldo_pk", type="integer")
     * @ORM\GeneratedValue(strategy="AUTO")
     */
    private $codigoProgramacionRespaldoPk;
     ...
     * @return mixed
     */
    public function getCodigoProgramacionRespaldoPk()
    {
        return $this->codigoProgramacionRespaldoPk;
    }

    /**
     * @param mixed $codigoProgramacionRespaldoPk
     */
    public function setCodigoProgramacionRespaldoPk($codigoProgramacionRespaldoPk): void
    {
        $this->codigoProgramacionRespaldoPk = $codigoProgramacionRespaldoPk;
    }
