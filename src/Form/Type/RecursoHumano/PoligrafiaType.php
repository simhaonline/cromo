...
class PoligrafiaType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('tipoPoligrafista', ChoiceType::class, array('choices' => array('' => '', 'INTERNO' => 'INTERNO', 'EXTERNO' => 'EXTERNO')))
            ->add('poligrafiaTipoRel', EntityType::class, [
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => RhuPoligrafia::class,
        ]);
    }
