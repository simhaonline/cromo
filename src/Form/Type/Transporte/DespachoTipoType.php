...
class DespachoTipoType extends AbstractType
{
    ...
    public function getEstructuraPropiedadesLista()
    {
        return '[	
            ...
            {"campo":"codigoComprobanteFk",             "tipo":"text",     "ayuda":"Codigo comprobante",        "titulo":"COMP"},	
            {"campo":"codigoCuentaFleteFk",             "tipo":"text",     "ayuda":"Codigo cuenta flete",        "titulo":"CTA FLETE"},	
            {"campo":"codigoCuentaRetencionFuenteFk",   "tipo":"text",     "ayuda":"Codigo cuenta retencion fuente","titulo":"CTA RTE FTE"},	
            {"campo":"codigoCuentaIndustriaComercioFk", "tipo":"text",     "ayuda":"Codigo cuenta industria comercio","titulo":"CTA ICA"},	
            {"campo":"codigoCuentaSeguridadFk",         "tipo":"text",     "ayuda":"Codigo cuenta seguridad",   "titulo":"CTA SEG"},	
            {"campo":"codigoCuentaCargueFk",            "tipo":"text",     "ayuda":"Codigo cuenta cargue",      "titulo":"CTA CAR"},	
            {"campo":"codigoCuentaEstampillaFk",        "tipo":"text",     "ayuda":"Codigo cuenta estampilla",  "titulo":"CTA EST"},	
            {"campo":"codigoCuentaPapeleriaFk",         "tipo":"text",     "ayuda":"Codigo cuenta papeleria",   "titulo":"CTA PAPA"},	
            {"campo":"codigoCuentaAnticipoFk",          "tipo":"text",     "ayuda":"Codigo cuenta anticipo",    "titulo":"CTA ANT"},  	
            {"campo":"codigoCuentaPagarFk",             "tipo":"text",     "ayuda":"Codigo cuenta pagar",    "titulo":"CTA PAG"},	
