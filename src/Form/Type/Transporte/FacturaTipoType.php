...
class FacturaTipoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('codigoCuentaIngresoTerceroFk',TextType::class,['required' => false,'label' => 'Codigo cuenta ingreso flete tercero fk:'])
            ...
            ->add('naturalezaCuentaIngresoTercero',TextType::class,['required' => false,'label' => 'Naturaleza cuenta ingreso:'])
