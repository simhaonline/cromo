...
class ExistenciaLote extends \FPDF {
    ...
    public function EncabezadoDetalles() {
        $this->Ln(34);
        $header = array('ITEM', 'NOMBRE','MARCA', 'BODEGA', 'LOTE', 'EXISTENCIA', 'CANT DISPONIBLE');
    ...
    public function Body($pdf)
    {
        ...
        foreach ($arExistenciaLote as $arExistenciaLote) {
            ...
            $pdf->Cell(48, 4, $arExistenciaLote['itemNombre'], 1, 0, 'L');
            $pdf->Cell(30, 4, $arExistenciaLote['marca'], 1, 0, 'L');
            $pdf->Cell(20, 4, $arExistenciaLote['codigoBodegaFk'], 1, 0, 'L');
            $pdf->Cell(20, 4, $arExistenciaLote['loteFk'], 1, 0, 'L');
            $pdf->Cell(30, 4, number_format($arExistenciaLote['cantidadExistencia']), 1, 0, 'R');
            $pdf->Cell(30, 4, number_format($arExistenciaLote['cantidadDisponible']), 1, 0, 'R');
            $pdf->Ln();
