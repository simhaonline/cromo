...
class ControlFactura extends \FPDF
{
    ...
    public function Body($pdf, $fecha)
    {
        ...
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->SetFont('Arial', 'b', 7);
        $pdf->Cell(38, 4, number_format($arFacturasTipo[0]['vrTotalOperado']+ $arFacturasTipo[1]['vrTotalOperado'] + $arFacturasTipo[2]['vrTotalOperado']), 1, 0, 'R', 1);
        $pdf->SetX(113);
        $pdf->SetTextColor(0);
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->SetFont('Arial', 'b', 7);
        ...
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->SetFont('Arial', 'b', 7);
        $pdf->Cell(44, 4, 'TOTAL VENTAS - NOTAS', 1, 0, 'L', 1);
        $pdf->SetX(54);
        $pdf->SetTextColor(0);
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->SetFont('Arial', 'b', 7);
        ...
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->SetFont('Arial', 'b', 7);
        $pdf->Cell(44, 4, 'VENTAS GRAVAS EXENTAS - NOTAS', 1, 0, 'L', 1);
        $pdf->SetX(157);
        $pdf->SetTextColor(0);
        $pdf->SetDrawColor(0, 0, 0);
        $pdf->SetFont('Arial', 'b', 7);
