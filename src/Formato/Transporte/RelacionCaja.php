...
class RelacionCaja extends \FPDF {
    ...
    public function EncabezadoDetalles() {
        $this->Ln(12);
        $header = array('ID', 'FECHA', 'TIPO', 'GUIA', 'NUMERO','F_ING', 'FLETE', 'MANEJO', 'TOTAL');
        ...
        $w = array(15, 25, 25, 25, 25, 25, 15, 15, 15);
    ...
    public function Body($pdf) {
        ...
        if($arRecibos) {
            foreach ($arRecibos as $arRecibo) {
                ...
                $pdf->Cell(25, 4, $arRecibo['codigoGuiaTipoFk'], 1, 0, 'L');
                $pdf->Cell(25, 4, $arRecibo['codigoGuiaFk'], 1, 0, 'L');
                $pdf->Cell(25, 4, $arRecibo['guiaNumero'], 1, 0, 'L');
