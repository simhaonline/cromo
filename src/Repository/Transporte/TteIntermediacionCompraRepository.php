...
class TteIntermediacionCompraRepository extends ServiceEntityRepository
{
    ...
    {
        $queryBuilder = $this->getEntityManager()->createQueryBuilder()->from(TteIntermediacionCompra::class, 'id')
            ->select('id.codigoIntermediacionCompraPk')
            ...
            ->leftJoin('id.poseedorRel', 'p')
            ->where('id.codigoIntermediacionFk = ' . $codigoIntermediacion)
        ->orderBy('id.codigoPoseedorFk');
